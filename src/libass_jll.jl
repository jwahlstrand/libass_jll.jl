...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libass_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("0ac62f75-1d6f-5e53-bd7c-93b484bb37c0"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libass", artifacts_toml) for e in artifacts["libass"]]
...
if best_platform === nothing
    @debug("Unable to load libass; unsupported platform $(triplet(platform_key_abi()))")
else
